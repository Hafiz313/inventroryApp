                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      isBrandView? Container(
                          ...
                          child: _brandController.brandList.isNotEmpty?

                          Obx(() {
                            if (_brandController.isLoading.value) {
                              return Container(
                                height: 50,
                                child: SpinKitWave(color: kAppPrimaryColor,size: AppSizes.appVerticalLg *0.55,),
                              );
                                  ...
                                  child: ListView.builder(
                                    ...
                                    itemBuilder: (context, index) {
                                      return GestureDetector(
                                          ...
                                          child: ListTile(
                                            title:
                                            Text(_brandController.brandList[index].name),
                                          ));
                                    },
                                  ),
                                ),
                 ...
                 /*       SearchableDropdown(
                      ...
                      Container(
                        ...
                        child:roundRectangleBtn(txt: "Search",textColor: kPrimaryTextColor,bgColor: kAppPrimaryColor,onPressed: () async {
                         ...
                         var url = Uri.parse("http://cserp.southeastasia.cloudapp.azure.com:55080/api/Inventory?Brand=$selectBrandCode&Category=$selectCategoryCode&SubCategory=$selectSubcategoryCode&ItemName=${_itemNameController.text.toString()}&Fyear=${ PreferenceUtils.getString(kShareLoginFyear)}&pagesize=50&pageno=1");
